...
"""Функція re.compile() використовується для компіляції регулярного виразу в об'єкт шаблону (pattern object), 
який може бути використаний для здійснення пошуків. Це корисно, коли потрібно використовувати один і той самий регулярний 
вираз багаторазово, оскільки компіляція регулярного виразу прискорює виконання операцій."""
...
# print(value)  # Not Found
"""Видалення значення за ключем за допомогою ключового слова del"""
# my_dict = {
#     "key1": "value1",
#     "key2": "value2",
#     "key3": "value3"
# }
# # Видалення елемента за ключем "key2"
# del my_dict["key2"]
# print(my_dict)  # Виведе {'key1': 'value1', 'key3': 'value3'}
...
Клас — це шаблон для створення об'єктів. Він визначає атрибути та методи, які будуть спільними для всіх об'єктів цього класу.
Об'єкт — це екземпляр класу. Кожен об'єкт має свій власний набір значень для атрибутів, визначених у класі.
Атрибути та Методи:

Атрибути — це змінні, які зберігають дані об'єкта.
Методи — це функції, які визначені всередині класу і можуть виконувати дії з атрибутами об'єкта."""


# class Human: # створення класу
...
#
#     def get_name(self):   # метод класу
#         return self.name
#
#     def get_name_and_age(self):   # метод класу
#         return self.name, self.age
#
# human_1 = Human(age=25, name='Musya', gender='Gey') # створення об'єкту класу
#
# print("age =",human_1.age, "Name =", human_1.name, "Gender =", human_1.gender)
# print(human_1.get_name())  # виклик методду класу
...
# human = Human(age=45)
# human.say_hello()
# human2 = HumanExtended(age=30, name='Bazya')
# human2.say_hello()
...
#
#     def can_build(self):  # конфлікт класів, зверху вниз
#         print("I am a doctor, I can build not so much")
#
# class Architect:
#     def can_build(self):
#         print("I am an architect, I can build")
#
# class Person(Doctor, Architect): # конфлікт класів
#     pass
#     # def can_build(self):
#     #     print("I am a human, I can build as well")
#
# s = Person()
# print(s.can_cure())
# print(s.can_build())
